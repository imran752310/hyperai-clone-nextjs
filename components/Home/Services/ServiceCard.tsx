        ...
        <div data-aos="zoom-in" data-aos-offset="200" className="p-2 my-5">
          <div className=" text-center bg-white   rounded-lg shadow-lg">
            <div className="p-6">
              <RiLineChartFill
                size={60}
                className="mx-auto text-purple-700 m-4"
              />
            ...
            <div className="  text-white p-6 rounded-lg">
              <button className="cursor-pointer bg-purple-700 text-white py-2 px-6 flex items-center rounded-sm hover:bg-purple-800 hover:text-white transition hover:animate-pulse">
                Get a Started
                <GoArrowUpRight />
              </button>
            </div>
        ...
        <div data-aos="zoom-in" data-aos-offset="300" className="p-2 my-5">
          <div className=" text-center  bg-gradient-to-t from-blue-800 to-purple-500 text-white  rounded-lg shadow-lg">
            ...
            <div className="  bg-blue-900 text-white p-6 rounded-lg">
              <button className="cursor-pointer text-black bg-white py-2 px-6 flex items-center rounded-sm hover:bg-purple-800 hover:text-white transition hover:animate-pulse">
                Learn more
                <GoArrowUpRight />
              </button>
            </div>
