...
const Hero = () => {
    return (
        <section className="w-[90%] h-[600] mx-auto  relative flex flex-col md:flex-row items-center justify-between bg-gradient-to-r from-blue-500 to-purple-500 text-white p-10 md:p-20 rounded-3xl">
