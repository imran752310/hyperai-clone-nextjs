      ...
      <section className="w-[80%] mx-auto my-20 flex flex-col md:flex-row items-center py-16 gap-20">
        <div className="relative w-full md:w-1/2">
          ...
          <RiLineChartFill size={60} className="mx-auto m-4" />
            ...
            <div className="  bg-blue-900 text-white p-6 rounded-lg">
              ...
              <p className="text-sm flex items-center gap-2"><FaPhoneVolume /> +123-456-789</p>
            </div>
          </div>
        </div>
        <div className="w-full md:w-1/2">
          ...
          <ul className="mt-4 font-semibold space-y-2">
            ...
            <li className="flex items-center gap-2"><span className="text-purple-700">✔</span> Seamless Integration</li>
          </ul>
          <button className="bg-purple-700 text-white px-6 py-3 rounded-md mt-6">Our Services →</button>
        </div>
      </section>
    );
  };
