  ...
  return (
    <nav className="w-[90%] mx-auto flex justify-between items-center py-5 bg-white">
      ...
      >
        ...
        <button className="bg-purple-700 text-white px-6 py-2 flex rounded-sm">
          Get a Quote
          <GoArrowUpRight />
        </button>
      </div>
      ...
      {isMobileMwnuOpen && (
        <div className="fixed inset-0 transform transition-all duration-500 z-[1002]  w-full h-screen">
          <div
            data-aos="fade-down"
            className="text-white    justify-center flex flex-col h-[400px] rounded-b-lg transform transition-all duration-500 delay-300 w-[100%] sm:w-[95%] bg-blue-900   space-y-6 z-[1050]"
          >
            <CgClose
              onClick={() => setIsMobileMenuOpen(!isMobileMwnuOpen)}
